    ...
    <div class="container flex justify-center mx-auto px-6 py-2 space-x-4">
        ...
        <div x-data="{ open: false }" class="relative">
            <button
                ...
                type="button"
                class="inline-flex items-center space-x-1 hover:underline focus:outline-none"
                aria-haspopup="true"
      ...
      <!-- Nested dropdown container -->
       ...
       <li x-data="{ magOpen: false }" class="relative">
        ...
        >
          <ul class="py-1" role="menu" aria-label="Magazines list">
            <li>
              <a href="#monthly" class="block px-4 py-2 hover:underline text-sm font-medium" role="menuitem">Fundi Abdull</a>
            </li>
            <li>
              <a href="#annual" class="block px-4 py-2 hover:underline text-sm font-medium" role="menuitem">Mnadani</a>
            </li>
            <li>
              <a href="#special-editions" class="block px-4 py-2 hover:underline text-sm font-medium" role="menuitem">Mombasa</a>
            </li>
          </ul>
        </div>
      </li>
       <li x-data="{ magOpen: false }" class="relative">
        ...
        >
          <ul class="py-1" role="menu" aria-label="Magazines list">
            <li>
              <a href="#monthly" class="block px-4 py-2 hover:underline text-sm font-medium" role="menuitem">Mombasa Phase II</a>
            </li>
            <li>
