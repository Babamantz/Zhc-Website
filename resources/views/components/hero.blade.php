<div class="w-full" x-data="carousel()" x-init="start()" @mouseenter="pause()" @mouseleave="resume()">
...
<script>
    function carousel() {
        return {
            ...
            interval: null,
            slides: [{
                    title: 'Welcome to Zanzibar Housing Corporation',
                    description: 'Providing affordable and quality housing solutions across the islands.',
                    link: '/properties',
                    image: 'https://source.unsplash.com/1600x900/?house,zanzibar'
                },
                {
                    title: 'Modern Living Spaces',
                    description: 'Enjoy comfort, convenience, and great designs.',
                    link: '/properties',
                    image: 'https://source.unsplash.com/1600x900/?modern,apartment'
                },
                {
                    title: 'Secure and Sustainable',
                    description: 'Built to last, designed with safety in mind.',
                    link: '/about-us',
                    image: 'https://source.unsplash.com/1600x900/?home,sustainable'
                }
            ],
            start() {
