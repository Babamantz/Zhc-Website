<div class="w-full lg:w-7/12 z-10">
    <div class="flex flex-wrap">
        ...
        <div class="w-full md:w-5/12 pl-0 md:pl-6 text-white text-center sm:text-center md:text-left">
            ...
            @foreach ([['label' => 'Home', 'url' => '/'], ['label' => 'Contact Details', 'url' => '/contacts'], ['label' => 'Mission and Vision', 'url' => '/about_us'], ['label' => 'FAQs', 'url' => '/faqs'], ['label' => 'What we do?', 'url' => '/about/about_us'], ['label' => 'Who we Are?', 'url' => '/about/about_us'], ['label' => 'Who we Serve?', 'url' => '/about/about_us']] as $link)
