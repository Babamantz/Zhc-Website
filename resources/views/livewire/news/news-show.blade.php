                ...
                <div class="flex items-start gap-4 mb-4">
                    ...
                    <div class="flex flex-col justify-center">
                        ...
                        <div class="text-sm text-gray-600 mt-1 flex items-center">
                            <i class="fa fa-calendar mr-1 text-gray-500"></i> {{ \Carbon\carbon::parse($news['date'])->format('y-M-Y') }}
                        </div>
                        ...
                        <img src="{{ $news['images'][0]['original'] }}" alt="{{ $news['title'] }}" class="w-full h-55 object-cover rounded-md" />
